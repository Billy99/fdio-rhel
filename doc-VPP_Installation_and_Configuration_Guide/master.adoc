...
.Prerequisite
A base installation of Red Hat Enterprise Linux 7 that has been updated to the latest minor release is available.
Your system meets the minimum requirements list in (xref to  Requirements).
